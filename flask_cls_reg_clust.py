...
def uploadFile():
    if request.method == 'POST':
        ...
        return render_template('Front page2.html')
...
# Importing the libraries
    ...
    return render_template('Classification.html', accuracy_score='Accuracy Score = {}'.format(accuracy),
...
def showResultreg():
    ...
    # uploaded_df_html = uploaded_df.to_html()
    # return render_template('show_csv_data.html', data_var=uploaded_df_html)
    return render_template('regression.html', r_squared_value='R_Squared Value = {}'.format(r_squared),
...
def showResultclust():
    ...
    return render_template('clustering.html', Inirtia_value='The Inirtia Value is = {}'.format(Inirtia))
